...
crcbot is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running crcbot Locally

You can test your hubot by running the following.

You can start crcbot locally by running:
...
Then you can interact with crcbot by typing `crcbot help`.

    crcbot> crcbot help

    crcbot> animate me <query> - The same thing as `image me`, except adds a few
